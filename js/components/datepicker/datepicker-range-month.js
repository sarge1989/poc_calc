(function ($) {
    $.fn.DatepickerRangeMonth = function () {
      const version = "4.1.0";
      ...
      for (let i = 0; i < datePickerContainer.length; i++) {
        ...
        const minDate = "1 Aug 2021"; // set min date
        ...
        if (datepickerInputRange) {
          ...
          datepickerInputFrom.datepicker.setDate(currentMonth); // set default date value From
          datepickerInputTo.datepicker.setDate(currentMonth); // set default date value To
